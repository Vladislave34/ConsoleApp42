...
//// 1. Отримати області
//var areaRequest = new NovaPoshtaRequest
//{
//    ApiKey = apiKey,
//    ModelName = "Address",
//    CalledMethod = "getSettlementAreas",
...
//var areaResponse = await PostToNovaPoshtaAsync<AreaEntity>(areaRequest);
//var areas = areaResponse?.Data;

//if (areas == null || areas.Length == 0)
//{
//    Console.WriteLine("Області не знайдено.");
//    return;
//}

//Console.WriteLine("Отримано області:");
//foreach (var area in areas)
//    Console.WriteLine($"{area.Ref}: {area.Description}");

//// 2. Отримати міста для кожної області
//foreach (var area in areas)
//{
//    Console.WriteLine($"\nМіста для області: {area.Description}");

//    for (int page = 1; page <= 10; page++)
//    {
//        var cityRequest = new NovaPoshtaRequest
//        {
//            ApiKey = apiKey,
//            ModelName = "Address",
//            CalledMethod = "getSettlements",
...
//        var cityResponse = await PostToNovaPoshtaAsync<CityEntity>(cityRequest);
//        if (cityResponse?.Data == null || cityResponse.Data.Length == 0)
//            break;

//        foreach (var city in cityResponse.Data)
//            Console.WriteLine($"{city.Ref}: {city.Description}");
//    }
//}
